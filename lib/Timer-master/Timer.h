...
public:
  ...
  int8_t every(unsigned long period, void (*callback)(void*),void*);
  int8_t every(unsigned long period, void (*callback)(void*), void*,int repeatCount);
  int8_t after(unsigned long duration, void (*callback)(void*),void*);
  int8_t every(unsigned long period, void (*callback)(uint8_t),uint8_t);
  int8_t every(unsigned long period, void (*callback)(uint8_t), uint8_t,int repeatCount);
  int8_t after(unsigned long duration, void (*callback)(uint8_t),uint8_t);
  uint8_t getValue(int8_t id);
